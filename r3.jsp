...
String sql ="select roomimage , roomno from rooms where roomid = 3";
...
<center>
<input type="image" src="room3.jpg" name="submit" width="669" height="300" /> 
</center>
<br>
<h2 style="color:red;" > Room Type : Triple Bed Room
<br>
<h2 style="color:red;" > Room Capacity : 3
<br>
