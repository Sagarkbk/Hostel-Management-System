...
String sql ="select roomimage , roomno from rooms where roomid = 4";
...
<center>
<input type="image" src="room4.jpg" name="submit" width="669" height="300" /> 
</center>
<br>
<h2 style="color:red;" > Room Type : Quard Bed Room
<br>
<h2 style="color:red;" > Room Capacity : 4
<br>
