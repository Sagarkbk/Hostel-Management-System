...
String sql ="select roomimage , roomno from rooms where roomid = 1";
...
<center>
<input type="image" src="room1.jpg" name="submit" width="669" height="300" /> 
</center>
<br>
<h2 style="color:red;" > Room Type : Single Bed Room
<br>
<h2 style="color:red;" > Room Capacity : 1
<br>
