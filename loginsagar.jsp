...
<style>
body {
  background-image: url('sagarerror.jpg');
...
{
response.sendRedirect("http://localhost:7036/SRKR/adminrooms.jsp");
}
else
{
int y=0;
...
String sql ="select userid , password from registersagar";
...
{      
  ...
  String password=resultSet.getString("password"); 
	...
	response.sendRedirect("http://localhost:7036/SRKR/userrooms.jsp"); 
	 y=y+1;
